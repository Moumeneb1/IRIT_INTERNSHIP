...
class Train:
    ...
    def fit_crossValidation(self, model, train_dataloader, validation_dataloader, epochs, device, optimizer, scheduler, criterion, writer=0, print_each=40):
        # Set the seed value all ovr the place to make this reproducible.
        seed_val = 2
    ...
    def fit_ThreeTask(self, model, train_dataloader, validation_dataloader, epochs, device, optimizer, scheduler):
        # Set the seed value all ovr the place to make this reproducible.
        seed_val = 2
    ...
    def fit_TwoTask(self, model, train_dataloader, validation_dataloader, epochs, device, optimizer, scheduler):
        # Set the seed value all ovr the place to make this reproducible.
        seed_val = 2
        ...
        for epoch_i in range(0, epochs):
            ...
            for batch in validation_dataloader:
                ...
                # Unpack the inputs from our dataloader
                b_input_ids, b_input_mask, b_labels_cat, b_labels_cat3 = batch
                ...
                # Move logits and labels to CPU
                logits = logits.detach().cpu().numpy()
                label_ids = b_labels_cat3.to('cpu').numpy()
